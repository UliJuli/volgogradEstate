        ...
        <div className="checkbox form-check form-check-inline">
          ...
          <div className="boxcheck">
            <div className="form-check form-check-inline">
              <input name="roomCount-1" className="form-check-input" type="checkbox" id="roomCount-1" defaultValue="option1" />
              <label className="form-check-label" htmlFor="roomCount-1">1</label>
            </div>
            <div className="form-check form-check-inline">
              <input name="roomCount-2" className="form-check-input" type="checkbox" id="roomCount-2" defaultValue="option2" />
              <label className="form-check-label" htmlFor="roomCount-2">2</label>
            </div>
            <div className="form-check form-check-inline">
              <input name="roomCount-3" className="form-check-input" type="checkbox" id="roomCount-3" defaultValue="option3" />
